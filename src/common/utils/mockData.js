...
export function generateMockData(
  ...
  let privacyLevelText =
    "This country has strong data protection laws (GDPR Equivalent)";
  ...
  if (lowerCountry.includes("india")) {
    ...
    privacyLevelText =
      "Excellent data protection laws strictly protecting users";
    privacyLevelVal = 9;
    riskScore = "1 / 10";
    riskScoreVal = 1;
  } else if (
  ...
  if (userLocation && userLocation.lat && userLocation.lon) {
    ...
    if (
      ...
      userLocation.country.toLowerCase().includes("india")
    ) {
  ...
  const trackers = [
    {
      ...
      status: "Blocked",
      favicon:
        "https://www.google.com/s2/favicons?domain=analytics.google.com&sz=16",
    },
    {
      name: "Facebook Pixel",
